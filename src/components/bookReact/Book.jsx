...
export function BookReact(props, index, img, title, col, long) {
  ...
  if (props.title != "settings"){
    return(
      <a id={`${props.title}`} href={`/${props.title}`} onMouseEnter={MouseEnter} onMouseLeave={MouseLeave} className="item  w-[50px] h-[220px]  sm:w-[40px] sm:h-[180px] 2xl:w-[50px] 2xl:h-[240px]" style={{"--long":props.long,"--i": props.index, "--urlimg": "url("+props.img+")", "--col": props.col}}>
